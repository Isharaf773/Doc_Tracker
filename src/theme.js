...
export const pages = [
  ...
  { id: "documents", label: "Records", icon: "ti-files", badge: "248", section: "main" },
  ...
  { id: "users", label: "Users", icon: "ti-users", badge: "12", section: "mgmt" },
  { id: "reports", label: "Reports", icon: "ti-chart-bar", section: "mgmt" },
  { id: "notifications", label: "Notifications", icon: "ti-bell", badge: "5", badgeColor: RED, section: "mgmt" },
